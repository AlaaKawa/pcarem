   ...
   <div class="col">
      <div class="card shadow mb-4">
         <div class="card-body">
            ...
            <div class="row justify-content-center">
               <div class="col">
                  <strong>{{ __('sentence.illness') }} </strong><br><br>
                  @forelse ($prescription_illness as $illness)
                  <li>{{ $illness->Illness->name_illness }} @empty(!$illness->illness_abriviation) - {{ $illness->illness_abriviation }} @endempty</li>
                  @empty
