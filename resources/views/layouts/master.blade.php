...
<html dir="ltr" lang="en" >
   ...
   <head>
      ...
      <link rel="icon" type="image/jpg" href="{{ asset('img/picon.jpg') }}">
          ...
          @endphp
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <li class="nav-item">
                  ...
                  <span>{{__('sentence.Long Term Diseas') }}</span>
                  </a>
                  <div id="collapseIllnesses" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('illness.create') }}">{{__('sentence.Add diseas') }}</a>
                        <a class="collapse-item" href="{{ route('illness.all') }}">{{__('sentence.All diseas') }}</a>
                     </div>
                  </div>
               </li>
               <!-- Divider -->
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                           ...
                           <img class="img-profile rounded-circle" src="{{ asset('img/picon.jpg') }}">
                           </a>
