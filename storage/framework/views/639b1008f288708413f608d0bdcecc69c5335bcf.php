...
<form method="post" action="<?php echo e(route('prescription.store')); ?>">
   ...
   <div class="row justify-content-center">
      ...
      <div class="col-md-8">
         <div class="card shadow mb-4">
            <div class="card-header py-3">
               <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('sentence.Long Term Diseas')); ?></h6>
            </div>
            <div class="card-body">
               <fieldset class="illness_labels">
                  <div class="repeatable"></div>
                  <div class="form-group">
                     <a type="button" class="btn btn-success add text-white" align="center"><i class='fa fa-plus'></i> <?php echo e(__('sentence.Add diseas')); ?></a>
                  </div>
               </fieldset>
            </div>
         </div>
...
<script type="text/template" id="illness_labels">
   <section>
                         <div class="row">
                             
                             <div class="col-md-6">
 <select class="form-control select2 select2-hidden-accessible" name="name_illness[]" id="illness" tabindex="-2" aria-hidden="true">
                                   <option value=""><?php echo e(__('sentence.Select diseas')); ?>...</option>
                                   <?php $__currentLoopData = $illness; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $illnesses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <option value="<?php echo e($illnesses->id); ?>"><?php echo e($illnesses->name_illness); ?></option>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                 </select>
                             </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pcare\pcarem\resources\views/prescription/create.blade.php ENDPATH**/ ?>