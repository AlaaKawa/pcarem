   ...
   <div class="col">
      <div class="card shadow mb-4">
         <div class="card-body">
            ...
            <div class="row justify-content-center">
               <div class="col">
                  <strong><?php echo e(__('sentence.illness')); ?> </strong><br><br>
                  <?php $__empty_1 = true; $__currentLoopData = $prescription_illness; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $illness): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <li><?php echo e($illness->Illness->name_illness); ?> <?php if(empty(!$illness->illness_abriviation)): ?> - <?php echo e($illness->illness_abriviation); ?> <?php endif; ?></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pcare\pcarem\resources\views/prescription/view.blade.php ENDPATH**/ ?>