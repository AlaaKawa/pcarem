                    ...
                    <div class="col-md-4 col-sm-6">
                      <center><img src="<?php echo e(asset('img/patient-icon.png')); ?>" class="img-profile rounded-circle img-fluid"></center>
                       <h4 class="text-center"><b><?php echo e($patient->name); ?></b></h4>
                            <hr>
                            <?php if(isset($patient->Patient->status)): ?>
                            <p><b><?php echo e(__('sentence.Status')); ?> :</b> <?php echo e($patient->Patient->status); ?></p> 
                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pcare\pcarem\resources\views/patient/view.blade.php ENDPATH**/ ?>