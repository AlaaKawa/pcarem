...
<html lang="en">
   <head>
      ...
      <link rel="icon" type="image/jpg" href="<?php echo e(asset('img/favicon.jpg')); ?>">
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                  ...
                  <div class="sidebar-brand-text mx-3">Doctor <sup>1.0</sup></div>
               </a>
               <!-- Divider -->
                  ...
                  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                           ...
                           <img class="img-profile rounded-circle" src="<?php echo e(asset('img/favicon.jpg')); ?>">
                           </a>
...
</html><?php /**PATH C:\xampp\htdocs\pms\resources\views/layouts/master.blade.php ENDPATH**/ ?>