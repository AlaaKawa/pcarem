            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                 <form method="post" action="<?php echo e(route('patient.create')); ?>">
                    ...
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-3 col-form-label"><?php echo e(__('sentence.Status')); ?><font color="red">*</font></label>
                      <div class="col-sm-9">
                        <select class="form-control" name="status">
                          <option value="Single"><?php echo e(__('sentence.Single')); ?></option>
                          <option value="Married"><?php echo e(__('sentence.Married')); ?></option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pcare\pcarem\resources\views/patient/create.blade.php ENDPATH**/ ?>