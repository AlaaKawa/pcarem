...
class PrescriptionController extends Controller{
    ...
    public function create(){
        ...
        $tests = Test::all();
    	return view('prescription.create',['illness' => $illness,'drugs' => $drugs, 'patients' => $patients, 'tests' => $tests]);
    }
    ...
    public function store(Request $request){
        ...
        if(isset($request->name_illness)):

            $j = count($request->name_illness);
    
            for ($x = 0; $x < $j; $x++) {
              
    
                $add_illness = new Prescription_illness;
    
                $add_illness->illness_id = $request->name_illness[$x];
                $add_illness->prescription_id = $prescription->id;
                $add_illness->save();
    ...
    public function view($id){
        ...
        $prescription_illness = Prescription_illness::where('prescription_id' ,$id)->get();
    	...
    	return view('prescription.view',['prescription' => $prescription, 'prescription_illness' => $prescription_illness, 'prescription_drugs' => $prescription_drugs, 'prescription_tests' => $prescription_tests]);
    }
