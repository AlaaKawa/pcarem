...
//Illness
Route::get('/illness/create', 'IllnessController@create')->name('illness.create');
Route::post('/illness/create', 'IllnessController@store')->name('illness.store');
Route::get('/illness/edit/{id}', 'IllnessController@edit')->where('id', '[0-9]+')->name('illness.edit');
Route::post('/illness/edit', 'IllnessController@store_edit')->name('illness.store_edit');
Route::get('/illness/all', 'IllnessController@all')->name('illness.all');
Route::get('/illness/delete/{id}','IllnessController@destroy');
